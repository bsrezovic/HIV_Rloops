...
#Map to HG19
bwa mem -t 22 -M $GENOME ${NAME}_R1.fq ${NAME}_R2.fq | samtools view -u -@ 10  | samtools sort -O BAM -m 5G -@ 10  > ${NAME}_hg19.sorted.bam
...
#map to HIV as well
bwa mem -t 22 -M $HIV ${NAME}_R1.fq ${NAME}_R2.fq | $SAMTOOLS view -u -@ 10  | $SAMTOOLS sort -O BAM -m 5G -@ 10  > ${NAME}_HIV1.sorted.bam
